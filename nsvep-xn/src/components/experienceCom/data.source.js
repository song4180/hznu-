    ...
    children: [
      {
        ...
        children: {
          ...
          img: {
            className: 'block-img kgz24lui94-editor_css',
            children:
              'https://iconfont.alicdn.com/s/29c04e8e-0dbe-4345-be29-2072c7dacddb_origin.svg',
          },
          icon: {
          ...
          time: {
            className: 'block-time kgz2agja5y7-editor_css',
